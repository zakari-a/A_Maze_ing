...
# Initialisation
  ...
  def mlx_release(self, mlx_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_release(mlx_ptr))

# Windows
  def mlx_new_window(self, mlx_ptr: Any, width: int, height: int, title: str) -> Any:
  ...
  def mlx_clear_window(self, mlx_ptr: Any, win_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_clear_window(mlx_ptr, win_ptr))

  def mlx_pixel_put(self, mlx_ptr: Any, win_ptr: Any, x: int, y: int, color: int) -> int:
    self.mlx_func.mlx_pixel_put.argtypes = [c_void_p, c_void_p, c_uint, c_uint, c_uint]
    self.mlx_func.mlx_pixel_put.restype = c_int
    return int(self.mlx_func.mlx_pixel_put(mlx_ptr, win_ptr, x, y, color))
  ...
  def mlx_destroy_window(self, mlx_ptr: Any, win_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_destroy_window(mlx_ptr, win_ptr))
...
# API break, returns tuple
  ...
  def mlx_put_image_to_window(self, mlx_ptr: Any, win_ptr: Any, img_ptr: Any, x: int, y: int) -> int:
    ...
    return int(self.mlx_func.mlx_put_image_to_window(mlx_ptr, win_ptr, img_ptr, x, y))
  ...
  def mlx_destroy_image(self, mlx_ptr: Any, img_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_destroy_image(mlx_ptr, img_ptr))
...
#  Use C^-\ to kill your program.
  ...
  def mlx_loop(self, mlx_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_loop(mlx_ptr))
  ...
  def mlx_loop_exit(self, mlx_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_loop_exit(mlx_ptr))

  def mlx_mouse_hook(self, win_ptr: Any, callback: Any, param: Any) -> int:
    ...
    if not callback:
      ...
      return int(self.mlx_func.mlx_mouse_hook(win_ptr, None, None))
    ...
    return int(self.mlx_func.mlx_mouse_hook(win_ptr, callback_ref, param))
  ...
  def mlx_key_hook(self, win_ptr: Any, callback: Any, param: Any) -> int:
    ...
    if not callback:
      ...
      return int(self.mlx_func.mlx_key_hook(win_ptr, None, None))
    ...
    return int(self.mlx_func.mlx_key_hook(win_ptr, callback_ref, param))
  ...
  def mlx_expose_hook(self, win_ptr: Any, callback: Any, param: Any) -> int:
    ...
    if not callback:
      ...
      return int(self.mlx_func.mlx_expose_hook(win_ptr, None, None))
    ...
    return int(self.mlx_func.mlx_expose_hook(win_ptr, callback_ref, param))
  ...
  def mlx_loop_hook(self, mlx_ptr: Any, callback: Any, param: Any) -> int:
    ...
    if not callback:
      ...
      return int(self.mlx_func.mlx_loop_hook(mlx_ptr, None, None))
    callback_type = CFUNCTYPE(None, py_object)
    ...
    return int(self.mlx_func.mlx_loop_hook(mlx_ptr, callback_ref, param))

  def mlx_hook(self, win_ptr: Any, x_event: int, x_mask: int, callback: Any, param: Any) -> int:
    x_event_key = [2, 3]
    x_event_mouse = [4, 5]
    x_event_motion = [6]
    ...
    if not callback:
      ...
      return int(self.mlx_func.mlx_hook(win_ptr, 0, 0, None, None))
    ...
    return int(self.mlx_func.mlx_hook(win_ptr, x_event, x_mask, callback_ref, param))

# Misc.

  def mlx_string_put(self, mlx_ptr: Any, win_ptr: Any, x: int, y: int, color: int, string: str) -> int:
    ...
    return int(self.mlx_func.mlx_string_put(mlx_ptr, win_ptr, x, y, color, string.encode('utf-8')))

# API break, returns tuple
  def mlx_xpm_file_to_image(self, mlx_ptr: Any, filename: str) -> Tuple[Any, int, int]:
    width = c_uint()
    height = c_uint()
...
# API break, returns tuple
  def mlx_png_file_to_image(self, mlx_ptr: Any, filename: str) -> Tuple[Any, int, int]:
    width = c_uint()
    height = c_uint()
...
#			  unsigned int *width, unsigned int *height);
  ...
  def mlx_mouse_hide(self, mlx_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_mouse_hide(mlx_ptr))
  ...
  def mlx_mouse_show(self, mlx_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_mouse_show(mlx_ptr))
  ...
  def mlx_mouse_move(self, mlx_ptr: Any, x: int, y: int) -> int:
    ...
    return int(self.mlx_func.mlx_mouse_move(mlx_ptr, x, y))
...
# API break, returns tuple
  def mlx_mouse_get_pos(self, mlx_ptr: Any) -> Tuple[int, int, int]:
    ...
    return (int(val), x.value, y.value)
  ...
  def mlx_do_key_autorepeatoff(self, mlx_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_do_key_autorepeatoff(mlx_ptr))
  ...
  def mlx_do_key_autorepeaton(self, mlx_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_do_key_autorepeaton(mlx_ptr))
...
# Sync funct
  ...
  def mlx_sync(self, mlx_ptr: Any, cmd: int, img_or_win_ptr: Any) -> int:
    ...
    return int(self.mlx_func.mlx_sync(mlx_ptr, cmd, img_or_win_ptr))
